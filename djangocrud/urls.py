...
urlpatterns = [
    ...
    path("guardar-resultados/", viewsp1.guardar_resultados, name="guardar_resultados"),
    path("resultados-primer-paso/", viewsp1.resultados_primer_paso, name="resultados-primer-paso"),
